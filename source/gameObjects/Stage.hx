	...
	public function new(curStage)
	{
		...
		switch (curStage)
		{
			...
			case 'last-stand':
				...
				var bg:FNFSprite = new FNFSprite( -600, 200).loadGraphic(Paths.image('backgrounds/' + curStage + '/bluebg'));
				bg.antialiasing = true;
				...
				var bg2:FNFSprite = new FNFSprite( -600, 200).loadGraphic(Paths.image('backgrounds/' + curStage + '/redfg'));
				...
				var rocks2:FNFSprite = new FNFSprite( -600, 200).loadGraphic(Paths.image('backgrounds/' + curStage + '/rocks2'));
				rocks2.antialiasing = true;
				...
				var rocks1:FNFSprite = new FNFSprite( -600, 200).loadGraphic(Paths.image('backgrounds/' + curStage + '/rocks1'));
				rocks1.antialiasing = true;
